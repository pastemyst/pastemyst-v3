<script lang="ts">
    ...
    interface Props {
        pasteWithLangStats: PasteWithLangStats;
    }

    let { pasteWithLangStats }: Props = $props();

    let dropdown: ReturnType<typeof Dropdown> | undefined = $state();
...
<div class="paste">
    <div class="flex row center space-between">
        ...
        <div class="flex row center gap-m">
            ...
            {#if pasteWithLangStats.encrypted}
                <div use:tooltip aria-label="encrypted" class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="icon">
                        <path
                            fill="currentColor"
                    ...
                    {#snippet dropdownSlot()}
                        <div>
                            <div class="dropdown flex col gap-s">
                                ...
                                <button
                                    class="dropdown-option delete flex gap-s"
                                    onclick={onDelete}
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
