...
export const testOption = new DirCommand("test");
testOption.subCommands = [];

for (let i = 0; i < 50; i++) {
    testOption.subCommands.push(new Command(`command ${i}`));
}

export const rootCommands: Command[] = [expiresSelect, testOption];
